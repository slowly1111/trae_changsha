        ...
        <div className="relative z-10 flex-1 flex flex-row-reverse justify-between items-stretch pl-8 pr-4 py-8">
          ...
          <div className="flex flex-row-reverse items-start gap-12 h-full pt-12">
            ...
            <div className="flex flex-col items-center gap-3 ml-4 opacity-70">
              ...
              {/* Removed shadow and text-shadow to ensure consistency on mobile */}
              <div className="w-6 h-6 border-2 border-[#D7342F] rotated-45 flex items-center justify-center rounded-sm bg-transparent">
                <span className="text-[10px] text-[#D7342F] font-bold font-serif scale-110">丙午</span>
              </div>
            </div>

            {/* Main Healing Text - Vertical */}
            <div className="writing-vertical-rl text-4xl text-[#2C1810] font-medium leading-[2.5] tracking-widest h-[650px] flex flex-wrap content-start gap-8"
              style={{
            ...
            <div className="relative group">
              ...
              <div className="text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#B8860B] to-[#8B4513]"
                style={{
                  ...
                  // Removed textShadow for consistency
                }}>
                {soulKeyword}
              </div>
            </div>
